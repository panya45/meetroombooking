<aside x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform"
    ...
    <nav class="mt-6">
        ...
        <ul class="mt-4">
            ...
            <li>
                <a href="{{ route('user.myBooking') }}" class="block py-3 px-6 hover:bg-gray-200 rounded-lg">
                    รายการจองของฉัน
                </a>
            </li>
            <li>
            ...
            <aside x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform"
                ...
                class="w-64 bg-white h-screen fixed left-0 top-0 border-r shadow-lg">

                <div class="p-6 relative">
                    <h1 class="text-xl font-bold text-blue-600">MeetRoomBooking</h1>
                </div>
                <button @click="sidebarOpen = false"
                    class="absolute top-4 right-4 text-gray-600 hover:text-gray-900 focus:outline-none">
